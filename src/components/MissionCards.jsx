...
const MissionCards = ({ title, description, link }) => {
  return (
    ...
    >
      <div className="min-h-[15vw] min-w-[25vw]  bg-[#CDC9C9] min-md:flex-wrap p-8 rounded-lg flex flex-col justify-between">
        <p className="text-xl">{description}</p>
        <div className="flex justify-between items-center mt-4">
          <h2 className="text-2xl border border-black px-12 rounded-full">{title}</h2>
          <Link className="">
            <motion.svg
